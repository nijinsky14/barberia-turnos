        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoraTurno = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Servicios",
                columns: new[] { "Id", "Activo", "Descripcion", "DuracionMinutos", "Nombre", "Precio" },
                values: new object[,]
                {
                    { 1, true, "Corte profesional", 30, "Corte Clásico", 5000m },
                    { 2, true, "Combo completo", 45, "Corte + Barba", 7500m },
                    { 3, true, "Perfilado de barba", 20, "Barba", 3500m },
                    { 4, true, "Corte para niños", 25, "Corte Niños", 4000m }
                });
